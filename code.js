...
function split(arr, low, high) {
    ...
    var subLen = Math.floor((high-low+1)/3);                // Calculate length of 1/3 of the array.
    ...
    var midSum = split(arr, lowMid, highMid);               // Split second third
    var rightSum = split(arr, highMid, high);               // Split last third
